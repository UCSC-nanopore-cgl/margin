...
for mismatch1, mismatch2, location in predictedMismatchLines:
    print("Predicted mismatch: %s %s %s %s %s" % (
        mismatch1, mismatch2, location, mismatch1 in trueMismatches or mismatch2 in trueMismatches,
        compareRLEs(mismatch1, mismatch2)))

print("True mismatches")
for mismatch1, mismatch2, location in trueMismatchLines:
    print("Predicted mismatch: %s %s %s %s %s" % (
        mismatch1, mismatch2, location, mismatch1 in predictedMismatches or mismatch2 in predictedMismatches,
        compareRLEs(mismatch1, mismatch2)))
